"""
Django settings for project project. test test 2 salami!
...
SECRET_KEY = "django-insecure-_9h(2*#y-784)(cgyd(#9)eof+ae1+%i*m#*0(lqtsl)rlzko!"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get("DJANGO_DEBUG", "True") == "True"

ALLOWED_HOSTS = ["dronet.propulsion-learn.ch"]
if DEBUG is True:
...
# Default primary key field type asdasd
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "https://dronet.propulsion-learn.ch",
]
